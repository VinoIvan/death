...
@section('title', 'Доступ запрещен - VCM Laser')
...
<div class="error-container">
    <div class="error-content">
        ...
        <div class="error-actions">
            <a href="{{ route('home') }}" class="btn-site">На главную</a>
            <a href="javascript:history.back()" class="btn-site-outline">Вернуться назад</a>
        </div>
    </div>
</div>
@endsection
